...
module.exports = function (grunt) {
    ...
    var pythonPath = 'python';//path.resolve("./node_modules/grunt-tps/tasks/lib/python/bin/python");
    var tpsmatePath = path.resolve("./node_modules/grunt-mytps/tasks/lib/tpsmate/src/cli.py");


    // Please see the Grunt documentation for more information regarding task
    // creation: http://gruntjs.com/creating-tasks

    grunt.registerMultiTask('mytps', 'upload your files to tps.', function () {
        var host = this;
